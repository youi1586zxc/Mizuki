	...
	links: [
		...
		// 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/youi1586zxc/Mizuki",
					external: true,
...
export const profileConfig: ProfileConfig = {
	...
	umami: {
		...
		shareId: "n1v9LfSuJEOe7HoO", //填入共享URL最后面那一串  比如：https://eu.umami.is/api/share/2dKQ5T0WrUn6AYtr 你就填入2dKQ5T0WrUn6AYtr
